...
\question{
  It is often convenient to add a reminder to ask a question -- either rhetorical within the text, or to whoever is proofreading your work.
}

\notecard{
  All these cards are drafting mark-up, so will not appear in your final copy.  If you want a card (of any kind) to appear in your final copy, make use of the \texttt{$\backslash$Card} command directly (it is defined in \texttt{Template/Macros}).
}
